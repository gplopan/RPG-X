...
public  class Player extends Entity {
    ...
    private void fire() {
        Rock aRock;
        if (direction == 0) {
            aRock = new Rock(x+sw/2-13, y+sh/2, 0, false,"ball");
        }
        else if (direction == 1) {
            aRock = new Rock(x+sw/2-13 , y+sh/2 , 1, false,"ball");
        }
        else if (direction == 2) {
            aRock = new Rock(x+sw/2-13, y+sh/2, 2, false,"ball");
        }
        else {
            aRock = new Rock(x+sw/2-13, y+sh/2 , 3, false,"ball");
        }
        rocks.add(aRock);
