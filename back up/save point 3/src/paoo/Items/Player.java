...
public class Player extends Entity {
    ...
    public void move(ArrayList<Item> items) {
        ...
        {
            case 0:
                if (items.get(20*(y/48)+x/48).getPassable() && items.get(20*(y/48)+(x+sw)/48).getPassable())
                    actuallyMove();
                else {
                    y = y - dy+1;
                    actuallyMove();
                ...
                break;
            case 1:
                if (items.get(20*(y/48)+(x+sw)/48).getPassable() && items.get(20*((y+sh)/48)+(x+sw)/48).getPassable())
                    actuallyMove();
                else {
                    x = x - dx-1;
                    actuallyMove();
            ...
            case 2:
                ...
                break;
            case 3:
                if (items.get(20*(y/48)+x/48).getPassable() && items.get(20*((y+sh)/48)+x/48).getPassable())
                    actuallyMove();
                else {
                    x = x - dx+1;
                    actuallyMove();
