...
public class Board extends JPanel implements ActionListener {
    ...
    private void initBoard(String lvl) {
    ...
    private void initBlocks(String lvl) {
        int type;
        try {
            for (int x = 0; x < Map.getLevel(lvl).length; x++) {
                for (int y = 0; y < Map.getLevel(lvl)[0].length; y++) {
                    type = Map.getLevel(lvl)[x][y];
                    ...
                    switch (bType) {
                        ...
                        case STONE3:
                            ...
                            break;
                        case LAVA:
                            items.add(new Item(y * 48, x * 48,"images/lava.png"));
                            break;
                        case WOOD2:
