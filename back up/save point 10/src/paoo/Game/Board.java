                ...
                for (int y = 0; y < Map.getLevel(level)[0].length; y++) {
                    ...
                    switch (bType) {
                        ...
                        case STONE2:
                            ...
                            break;
                        case STONE3:
                            items.add(new Item(y * 48, x * 48,"images/stone5.png",false));
                            break;
                        case LAVA:
                        ...
                        case WOOD1:
                            ...
                            break;
                        case STONE6:
                            items.add(new Item(y * 48, x * 48,"images/stone6.png",false));
                            break;
                        case WOOD3:
                        ...
                        case PATH190:
                            ...
                            break;
                        case BRIDGE:
                            items.add(new Item(y*48,x*48,"images/bridge2.png"));
                            break;
                        default:
                            break;
                    }
