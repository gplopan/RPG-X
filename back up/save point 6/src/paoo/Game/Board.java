...
public class Board extends JPanel implements ActionListener {
    ...
    static volatile public boolean gameOver=false;
    ...
    public void killAndDismember(int code)
    {
        if(code<0)
        {
            instance=null;
            GameView.instance.dispose();
            GameView.instance=null;
            Greeting.getInstance("images/game_over.png").setVisible(true);
        }
        code++;
    }
